...
export interface ApiDatapointDatapoint extends Struct.CollectionTypeSchema {
  collectionName: 'datapoints';
  info: {
    displayName: 'Datapoint';
    pluralName: 'datapoints';
    singularName: 'datapoint';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dataset: Schema.Attribute.Relation<'manyToOne', 'api::dataset.dataset'>;
    extra: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::datapoint.datapoint'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiDatasetDataset extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    datapoints: Schema.Attribute.Relation<
      'oneToMany',
      'api::datapoint.datapoint'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    source_file: Schema.Attribute.Media<'files'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDocumentDocument extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['rapport', 'contrat', 'facture', 'presentation', 'autre']
    > &
